...
export default function App() {
  ...
  async function sendTransfer({ amount, recipientName, countryCode, walletAddress }) {
  ...
  useEffect(() => {
    ...
    const handle = () => { setAccount(null); setSigner(null); setNetworkOk(false); setUsdcBalance(0); setTxHistory([]); setStats({ count:0, volume:"0.00" }); };
    ...
    <div className="app-root">
        ...
        <div className="sidebar-bottom">
          {account ? (
            <>
              ...
              <button className="btn-receive" onClick={() => setShowReceive(true)}>Receive</button>
            </>
          ) : (
      ...
      <main className="main-area">
          ...
          <div className="topbar-right">
            <div className="balance-chip">
              ...
              <span className="balance-val">
                {account ? usdcBalance.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2}) : "---.--"}
              </span>
            </div>
        ...
        <div className="screen-content">
          ...
          {screen === "agent"   && <Agent usdcBalance={usdcBalance} account={account} />}
          ...
          <div className="modal-card" onClick={e => e.stopPropagation()}>
            ...
            {account ? (
              <>
                ...
                <button className="btn-primary" style={{ width:"100%" }} onClick={() => { navigator.clipboard.writeText(account); }}>
                  Copy Address
                </button>
